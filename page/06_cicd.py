...
def run():
    ...
    with show_pipe_cont:
        ...
        st.info("Pour résoudre les problématiques d'organisation, un Système de Pipelines Sklearn/Streamlit a été développé. ")
        USE_PIPELINE_PAGE = st.checkbox("Afficher la section Pipeline Sklearn", value=False)
                ...
                with container_selection:
                    ...
                    with col1:
                        ...
                        selected_pipeline = st.selectbox(
                            ...
                            index=pkl_files.index("Pipeline_ML_PCA_Complete.pkl") if "Pipeline_ML_PCA_Complete.pkl" in pkl_files else 0
                        )
