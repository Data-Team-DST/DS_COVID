...
def run():
    ...
    _render_section(
        "2. Inventaire & volumétrie",
        f"Dataset : {DATASET_SLUG}\nTotal images et masks référencées : {DEFAULT_TOTAL}\n"
    ...
    # 6. ZIP download
    st.markdown("## 6. Télécharger l'échantillon (ZIP)")
    ...
    # 7. Résumé & prochaines actions
    st.markdown("## 7. Résumé & prochaines actions")
